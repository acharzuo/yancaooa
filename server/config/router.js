 ...
 //    { route: '/crashReporter', method: "post", authority: null, controller: 'logs/crashReporter.js', action: 'acceptLogs' },
      ...
      */
     // 获取员工列表
     { route: '/api/app/employee', method: 'get', authority: null, controller: 'api/employee/controller', action: 'list' },
     // 创建店铺
     { route: '/api/app/employee', method: 'post', authority: null, controller: 'api/employee/controller', action: 'create' },
 ...
 /**
      ...
      */
     // 获取当前订单
     { route: '/api/app/order', method: 'get', authority: null, controller: 'api/orders/controller', action: 'list' },
     // 创建新订单
     { route: '/api/app/order', method: 'post', authority: null, controller: 'api/orders/controller', action: 'create' },

     /**
      * 订单管理接口
      */
     // 获取子订单
     { route: '/api/app/subOrder', method: 'get', authority: null, controller: 'api/subOrders/controller', action: 'list' },
     // 创建新订单
     { route: '/api/app/subOrder', method: 'post', authority: null, controller: 'api/subOrders/controller', action: 'create' },

// 登录
      { route: '/api/app/user/login', method: 'post', authority: null, controller: 'api/orders/controller', action: 'login' },
